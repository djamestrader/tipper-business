    ...
    <section className="py-16 bg-neutralBackground">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <h2 className="section-title">Fair Dinkum Rubbish Removal Difference</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center p-8 bg-cardBackground rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="text-textMedium text-sm md:text-base">
