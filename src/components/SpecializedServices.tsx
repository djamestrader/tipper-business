    ...
    <section className="bg-primary-green py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Home Remodels */}
          <div className="bg-cardBackground p-6 rounded-lg shadow-md text-center hover:shadow-lg hover:border-2 hover:border-primary-green transition-all duration-300">
            ...
            <p className="text-textMedium mb-4">Make cleanup easy for your home remodel with our flexible tipper trailer hire or full-service team. Perfect for all renovation waste, keeping your renovation space clean and organized.</p>
          ...
          <div className="bg-cardBackground p-6 rounded-lg shadow-md text-center hover:shadow-lg hover:border-2 hover:border-primary-green transition-all duration-300">
            ...
            <p className="text-textMedium mb-4">Transforming your yard? Our tipper trailers are perfect for green waste, soil, and landscaping debris. Choose self-load or let our team handle the heavy lifting.</p>
            {/* Call to Action Buttons */}
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between items-center mt-6">
          ...
          <div className="bg-cardBackground p-6 rounded-lg shadow-md text-center hover:shadow-lg hover:border-2 hover:border-primary-green transition-all duration-300">
            ...
            <p className="text-textMedium mb-4">Keep your construction site organized with our reliable waste removal solutions. We handle construction materials like wood, metal, and concrete efficiently.</p>
            {/* Call to Action Buttons */}
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between items-center mt-6">
          ...
          <div className="bg-cardBackground p-6 rounded-lg shadow-md text-center hover:shadow-lg hover:border-2 hover:border-primary-green transition-all duration-300">
            ...
            <p className="text-textMedium mb-4">Simplify your move with our tipper trailer hire or full-service team. Get rid of old furniture and unwanted items with our flexible removal options.</p>
            {/* Call to Action Buttons */}
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between items-center mt-6">
